...
<div class="box">
    <br/>
    <h1 class="text-center text-white"><span class="glyphicon glyphicon-leaf"></span>&nbsp;&nbsp;JBOA办公自动化系统</h1>
    <div class="login-box">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12  ">
                            <div class="input-group">
                                ...
                                <input type="text" id="username" name="userNo" class="form-control" placeholder="用户名">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
